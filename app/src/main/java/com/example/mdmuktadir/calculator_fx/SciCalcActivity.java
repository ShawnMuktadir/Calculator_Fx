...
public class SciCalcActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sci_calc);
    ...
    private void obtainInputValues(String input){
        switch (input){
            ...
            case "ABS":
                ...
                break;
            case "MR":
                String mValue = getStoredPreferenceValue(SciCalcActivity.this);
